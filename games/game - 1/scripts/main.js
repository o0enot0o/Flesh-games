...
const highScoreBlock = document.getElementById("highscore-count");
...
toggleControlBtn.addEventListener("click", () => {
  mobileControlEnabled = !mobileControlEnabled;
  mobileControls.style.display = mobileControlEnabled ? "block" : "none";
});
